...
public class PersonTests
{
    ...
    public void Test_AddPeople_ReturnsListWithUniquePeople()
    {
        ...
        List<Person> expectedPeopleList = new() { new Person { Name = "Alice", Id = "A001", Age = 35 }, new Person { Name = "Bob", Id = "B002", Age = 30 } };
    ...
    public void Test_GetByAgeAscending_SortsPeopleByAge()
    {
        ...
        string expected = $"Bob with ID: B002 is 30 years old.{Environment.NewLine}Alice with ID: A001 is 35 years old.{Environment.NewLine}Stan with ID: A007 is 38 years old.";
        // Act
